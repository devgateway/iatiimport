...
module.exports = {
  ...
  FIELD_TYPE: {MULTILANG_STRING: 'MULTILANG_STRING', STRING:'STRING', LIST: 'LIST', LOCATION: 'LOCATION', DATE: 'DATE', TRANSACTION: 'TRANSACTION',ORGANIZATION: 'ORGANIZATION', DOCUMENT_LINK: 'DOCUMENT_LINK'},
  FIELD_TYPE_FRIENDLY_NAME: {MULTILANG_STRING: 'Multi-language', STRING:'String', LIST: 'List', LOCATION: 'Location', DATE: 'Date',TRANSACTION: 'Transaction',ORGANIZATION: 'Organization', DOCUMENT_LINK: 'Document Link'},
