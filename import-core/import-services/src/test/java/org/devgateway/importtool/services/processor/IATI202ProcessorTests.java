...
@ContextConfiguration(classes = IATI202ProcessorTests.TestIATI202ProcessorConfiguration.class)
@Transactional
public class IATI202ProcessorTests {
	...
	static class TestIATI202ProcessorConfiguration {
	}
	
	@Test	
	public void testIATIFileIsParsedCorrectly() throws Exception {
		ISourceProcessor transformer = new IATI201Processor();
		InputStream is = this.getClass().getResourceAsStream("sample_files/drc/activity-2.02.xml");
